...
class TestReflectionImports:
    ...
    def test_iter_import_objects(self):
        assert list(iter_import_objects('test.reflection.test_imports.P_*')) == [
            ...
            (P_2, 'test.reflection.test_imports', 'P_2'),
            (P_3, 'test.reflection.test_imports', 'P_3'),
        ]
        assert list(iter_import_objects('test.reflection.test_imports.???.*')) == [
            (P_1, 'test.reflection.test_imports', 'QQ3.P_1'),
            (P_2, 'test.reflection.test_imports', 'QQ3.P_2'),
            (P_3, 'test.reflection.test_imports', 'QQ3.P_3'),
        ]
